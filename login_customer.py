...
def procced():
    point = mysql.connector.connect(host = "localhost", user = "root", password = "anakha", database = "hr_emp")
    main_cursor = point.cursor()
    command =" select * from cust_admin where cust_user = %s and cust_password = %s"
...
r.title("Customer Management System")
r.config(bg="grey")
r.geometry("1100x700")
...
main_label = Label(Label_frame, text="Customer Management System", bg="firebrick", fg="goldenrod",font=("arial", 22, "bold"))
